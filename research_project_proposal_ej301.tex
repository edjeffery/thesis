...
\begin{table}[!tbp]
  ...
  \toprule
   {} & {Initial} & \multicolumn{2}{c}{Errors removed} & \multicolumn{2}{c}{Outliers removed} & \multicolumn{1}{c}{Total} \\
  \cmidrule(lr){2-2}
  \cmidrule(lr){3-4}
  \cmidrule(lr){5-6}
  \cmidrule(lr){7-7}
  Gas/particulate & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{Change} & \multicolumn{1}{c}{N} & \multicolumn{1}{c}{Change} & \multicolumn{1}{c}{Change} \\ \midrule
