...
In addition, Chapter \ref{chap:conclusion} concludes the project and details the limitations of our work. It also provides recommendations for future work.
...
Whilst it appears machine learning methods are the best available methods for low-cost sensor calibration, the aforementioned studies used stationary air quality monitoring. Thus, it is unclear how these methods would perform when calibrating in near real-time. This should be investigated further.
...
\toprule
Variable & \multicolumn{1}{c}{PM10} & \multicolumn{1}{c}{Ozone} & \multicolumn{1}{c}{General AQ} \\ 
\midrule
...
\begin{tabular}{l S[table-format=2.3] !{\qquad} S[table-format=2.3] !{\qquad} S[table-format=1.3]}
\toprule
Variable & \multicolumn{1}{l}{PM10} & \multicolumn{1}{l}{Ozone} & \multicolumn{1}{c}{General AQ} \\ 
\midrule
